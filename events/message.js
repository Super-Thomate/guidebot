...
module.exports = async (client, message) => {
  ...
  if ((settings.toggleCommandTrigger == "true") || (message.content.indexOf(settings.prefix) !== 0)) {
   ...
   client.connection.execute ("insert into wanshitong.`occurance` (message, guild_id) values (1, ?) on duplicate key update message=message+1 ;", [message.guild.id], (err, res) => {console.error ("occurrance message:", err)}) ;
